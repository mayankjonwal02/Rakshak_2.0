...
class DBHandler(context: Context?) : SQLiteOpenHelper(context, DB_NAME, null, DB_VERSION) {
    ...
    fun addPatientData(patientId: String?, ecg: Float?, heartRate: Float?, spo2: Float?, temperature: Float?) {
    ...
    fun getAllPatientData(): List<PatientData> {
        ...
        while (cursor.moveToNext()) {
            ...
            val patientData = PatientData(dataId, patientId, ecg, heartRate, spo2, temperature, timestamp)
